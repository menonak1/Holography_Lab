...
\textbf{Observation}: No three-dimensional image of the object was visible. The plate exhibited only broad spectral reflections and noise, but the wavefront of the figurine was not reconstructed. Tilting the plate (to check for parallax) yielded no visual results.
